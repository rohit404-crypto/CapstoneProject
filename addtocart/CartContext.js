...
export function CartProvider({children}){
  ...
  return(
    ...
    <CartContext.Provider value={{items,list,addToCart,updateCartItemQuantity, getTotalPrice,removeFromCart,addToWish,removeFromWish }}>{children}</CartContext.Provider>
  )
}
